          ...
          <div v-if="filteredCoursesByGradeAndTerm(grade, 'güz').length">
            ...
            >
              ...
              <span v-if="isAdmin" class="list-actions">
                <button aria-label="Dersi Düzenle" title="Dersi Düzenle" @click.stop="enterEditMode(c)">✎</button>
                <button aria-label="Dersi Sil" title="Dersi Sil" @click.stop="deleteCourse(c._id)">🗑</button>
              </span>
            </div>
          </div>
